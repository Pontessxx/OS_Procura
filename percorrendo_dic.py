...
def procura(dic, ano, site, tipo, mes, tipo_cabeamento,tipo_manutencao):
    ...
    def verificando_palavras_dic(word, my_dict):
        print('_______________________')
        rprint('[yellow]verificando_palavras_dic(word, my_dict)[yellow]\n')
        pprint(my_dict)
        try:
            for key in my_dict:
                if key and my_dict[key] and word:
                    if word.lower() in key.lower():
                        # print(f"A palavra '{word}' existe na chave '{key}' do dicionário.")
                        print(f'chave: {key}')
                        return key
        except:
            for chave in my_dict:
                print(f'chave: {chave}')
                print(f'valor: {my_dict[chave]}')
            return my_dict[chave]
        
    def manutencao_dic(chave, dic):
        for chave in dic:
            print(f'chave: {chave}')
    ...
    if ano in dic:
        ...
        if (ano == '2011')or (ano=='2012') or (ano=='2013') or (ano=='2014') or (ano=='2015')or (ano=='2016')or (ano=='2017') :
            #  or (ano=='2018') or (ano=='2019') or (ano=='2020') or (ano=='2021') or (ano=='2022') or (ano=='2023')
            print(f'\n\n{ano}            | \t if site in dic[ano]:')
            ...
            if site in dic[ano]:
                ...
                elif tipo in ['MANUTENÇÃO']:
                    if site in ['01 - CTI']:
                        if ano in ['2011', '2012','2016','2017']:
                            for key_mes in dic[ano][site][tipo]:
                                if key_mes.startswith(mes):
                                    found == True
                                    print(f'{key_mes}   | \t\t\t key_mes.startswith(mes)')
                        ...
                        if ano in ['2011','2012']:
                            ...
                            valor = verificando_palavras_dic(tipo_manutencao,dic[ano][site][tipo][key_mes])
                            valor = manutencao_dic(valor,dic[ano][site][tipo][key_mes])
                            return valor
            ...
            if (site == '02 - ALPHAVILLE') and (tipo =='MANUTENÇÃO'):
                for key_mes in dic[ano][site][tipo]:
                        if key_mes.startswith(mes):
                            found == True
                            print(f'{key_mes}   | \t\t\t key_mes.startswith(mes)')
...
incremento_input =  procura(dic, ano, site, tipo, mes, tipo_cabeamento,tipo_manutencao)
print(f'{incremento_input}          | \tINCREMENTO INPUT')
print('\n_______COMBOBOX - VALUES________')
print(f'{site}')
print(f'{tipo}')
print(f'{tipo_cabeamento}')
print(f'{tipo_manutencao}')
print('----------------------------------------------\n')
