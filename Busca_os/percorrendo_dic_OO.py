...
class MaintenanceFinder:
    ...
    def procura(self, ano, site, tipo, mes, tipo_cabeamento, tipo_manutencao):
        ...
        if ano in self.dic:
            if ano in ['2009']:
                ...
                return self._handle_2011_2022(ano, site, tipo, mes, tipo_cabeamento, tipo_manutencao)
            elif ano in ['2023']:
    ...
    def _handle_2011_2022(self, ano, site, tipo, mes, tipo_cabeamento, tipo_manutencao):
        console.print(f'\n\n{ano}            | \t if site in dic[ano]:')
        if site in self.dic[ano]:
            console.print(f'{site}        | \t\t if tipo in dic[ano][site]:')
            ...
            if tipo == 'MANUTENÇÃO':
                return self._handle_manutencao(ano, site, tipo, mes, tipo_manutencao)
    ...
    def _handle_manutencao(self, ano, site, tipo, mes, tipo_manutencao):
...
finder = MaintenanceFinder()
incremento_input = finder.procura(ano, site, tipo, mes, tipo_cabeamento, tipo_manutencao)
print(incremento_input)